...
{
    public static Numbers.Angle Radians(this float radians) => new(radians);
    public static Numbers.Angle Degrees(this float degrees) => new(degrees * Numbers.Angle.DegToRad);
    public static Numbers.Angle Degrees(this int degrees) => new(degrees * Numbers.Angle.DegToRad);
}
